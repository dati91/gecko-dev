...
impl LazyInitializedDebugRenderer {
    ...
    pub fn get_mut<'a>(&'a mut self, device: &mut Device<back::Backend>) -> &'a mut DebugRenderer {
...
impl Renderer
{
    ...
    pub fn new(
        ...
        let (adapter, mut surface) = {
            ...
            use x11::xlib::{ XOpenDisplay, XDefaultScreenOfDisplay, XRootWindowOfScreen, XQueryTree };
            ...
            let mut surface = unsafe {
                ...
                println!("root={:?}", root);
                let mut root_return = ptr::null_mut() as _;
                let mut parent_return = ptr::null_mut() as _;
                let mut children_return = ptr::null_mut() as _;
                let mut nchildren_return = ptr::null_mut() as _;
                ...
                println!("root_return = {:?}", root_return);
                println!("parent_return = {:?}", parent_return);
                println!("children_return = {:?}", children_return);
                println!("nchildren_return = {:?}", nchildren_return);

                // TODO maybe we should pass these from gecko...

                instance.create_surface_from_xlib(
                    display as _,
                    root as _
                )
            };
